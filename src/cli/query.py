...
def main():
    ...
    #print(pass_correct('pb', 'password'))
    ...
    #register_user('yl', 'hanna', 'lee', 'yun', 'ly@mail.com')
    # print(find_friend("ly@mail.com"))
    #print(follow_friend(find_friend("ly@mail.com"), 'pb'))
    # NOTE: it is empty array, but not same as none, need to check length of this
    #print(unfollow_friend('yl', 'pb'))
    # show_friend_list('pb')
    #print(play_song('pb', 'song100'))
    #play_album('pb', 'album1000')
    #play_collec('pb', 'collection1')
